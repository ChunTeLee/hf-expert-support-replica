...
css_lines = [
    ...
    ".bars-layer .bar-left { --side-x: var(--shift-left, 0px); }",
    ".bars-layer .bar-right { --side-x: calc(-1 * var(--shift-right, 0px)); }",
    "",
    "/* Tablet: relocate clipped LEFT cluster inward by 360px (4 grid cells). */",
    "/* Right cluster stays clipping naturally. Multiples of 90 preserve grid alignment. */",
    "@media (min-width: 768px) and (max-width: 1279px) {",
    "  .iso-stage { --shift-left: 360px; }",
    "}",
    "",
    "/* Mobile: pull both clusters inward (4 grid cells each = 360px). */",
    "@media (max-width: 767px) {",
    "  .iso-stage { --shift-left: 360px; --shift-right: 360px; }",
    "}",
    "",
]
